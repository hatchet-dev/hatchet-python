...
class StepRunArchive(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["stepRunId", "order", "input", "output", "startedAt", "error", "createdAt", "startedAtEpoch", "finishedAt", "finishedAtEpoch", "timeoutAt", "timeoutAtEpoch", "cancelledAt", "cancelledAtEpoch", "cancelledReason", "cancelledError"]

...
class InfraAsCodeCreateRequest(BaseModel):
    ...
    """ # noqa: E501
    runtime_configs: List[ManagedWorkerCreateRequestRuntimeConfig] = Field(alias="runtimeConfigs")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "runtimeConfigs": [ManagedWorkerCreateRequestRuntimeConfig.from_dict(_item) for _item in obj["runtimeConfigs"]] if obj.get("runtimeConfigs") is not None else None
        })
        return _obj

...
class ManagedWorkerRuntimeConfig(BaseModel):
    """
    ...
    region: ManagedWorkerRegion = Field(description="The region that the worker is deployed to")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ManagedWorkerRuntimeConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ManagedWorkerRuntimeConfig from a dict"""
        if obj is None:
            return None

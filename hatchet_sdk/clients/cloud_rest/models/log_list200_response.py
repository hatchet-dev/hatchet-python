...
from hatchet_sdk.clients.cloud_rest.models.log_list200_response_rows_inner import LogList200ResponseRowsInner
...
class LogList200Response(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rows": [LogList200ResponseRowsInner.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None,

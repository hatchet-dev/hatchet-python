...
from hatchet_sdk.clients.cloud_rest.models.managed_worker_events_list200_response_rows_inner import ManagedWorkerEventsList200ResponseRowsInner
...
class ManagedWorkerEventsList200Response(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rows": [ManagedWorkerEventsList200ResponseRowsInner.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
        return _obj

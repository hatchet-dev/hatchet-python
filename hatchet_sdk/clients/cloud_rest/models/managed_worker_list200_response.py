...
from hatchet_sdk.clients.cloud_rest.models.managed_worker_list200_response_rows_inner import ManagedWorkerList200ResponseRowsInner
...
class ManagedWorkerList200Response(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rows": [ManagedWorkerList200ResponseRowsInner.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None,

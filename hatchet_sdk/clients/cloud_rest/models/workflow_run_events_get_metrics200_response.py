...
from hatchet_sdk.clients.cloud_rest.models.workflow_run_events_get_metrics200_response_results_inner import WorkflowRunEventsGetMetrics200ResponseResultsInner
...
class WorkflowRunEventsGetMetrics200Response(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [WorkflowRunEventsGetMetrics200ResponseResultsInner.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj

...
from hatchet_sdk.clients.cloud_rest.models.managed_worker_instances_list200_response_rows_inner import ManagedWorkerInstancesList200ResponseRowsInner
...
class ManagedWorkerInstancesList200Response(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rows": [ManagedWorkerInstancesList200ResponseRowsInner.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
        return _obj

...
class ManagedWorkerList(BaseModel):
    """
    ManagedWorkerList
    """ # noqa: E501
    rows: Optional[List[ManagedWorker]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ManagedWorkerList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ManagedWorkerList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "rows": [ManagedWorker.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None,

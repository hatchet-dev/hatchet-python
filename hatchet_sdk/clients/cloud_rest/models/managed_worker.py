...
class ManagedWorker(BaseModel):
    ...
    runtime_configs: Optional[List[ManagedWorkerRuntimeConfig]] = Field(
        default=None, alias="runtimeConfigs"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "name": obj.get("name"),
                "buildConfig": (
                    ManagedWorkerBuildConfig.from_dict(obj["buildConfig"])
                ...
                "runtimeConfigs": (
                    [
                        ManagedWorkerRuntimeConfig.from_dict(_item)
